...
echo "Hello, user. This is script that audit your workstation."
echo "Please use sudo to run the script correcty."
sudo echo "Script output information about your workstation to file 'output_script_3.1.log'. Check it in your current directory."
